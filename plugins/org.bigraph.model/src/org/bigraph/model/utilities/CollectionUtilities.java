...
public abstract class CollectionUtilities {
	...
	public static final <T> Collection<T> collect(Iterable<? extends T> it) {
		return collect(it.iterator());
	}
	
	public static final <T> Collection<T> collect(Iterator<? extends T> it) {
	...
	public static final <T> Collection<T> collect(
