...
class BasicCommandLineInteractionManager extends InteractionManager {
	private static class ResultsContext {
		private String results;
		
		public ResultsContext(String results) {
		...
		public class ToolSelectorDialog extends Dialog {
			...
			private ToolSelectorDialog(Shell parentShell) {
				super(parentShell);
			}
		...
		public class ExportResultsDialog extends TitleAreaDialog {
			...
			private ExportResultsDialog(Shell parentShell) {
				super(parentShell);
			}
	...
	public void run(Shell parent) {
		try {
			...
			if (r == Dialog.OK) {
				...
				new ResultsContext(IOAdapter.readString(io.getInputStream())).
